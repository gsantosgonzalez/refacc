 ...
 * @property-read integer $dayOfWeek 0 (for DOMINGO) through 6 (for Sabado)
 * @property-read integer $dayOfYear 0 through 365
 * @property-read integer $weekOfMonth 1 through 5
 * @property-read integer $weekOfYear ISO-8601 week number of year, weeks starting on LUNES
...
class Carbon extends DateTime
{
     ...
     * @var int
     */
    protected static $weekStartsAt = self::LUNES;
     ...
     * @var int
     */
    protected static $weekEndsAt = self::DOMINGO;
     ...
     * @var array
     */
    protected static $weekendDays = array(self::SABADO, self::DOMINGO);
     ...
     * Carbon::parse('LUNES next week')->fn() rather than
     * (new Carbon('LUNES next week'))->fn()
     *
     * @param string|null              $time
     * @param DateTimeZone|string|null $tz
     *
    ...
    /**
     * Checks if this day is a DOMINGO.
     *
     * @return bool
     */
    public function isDOMINGO()
    {
        return $this->dayOfWeek === static::DOMINGO;
    }

    /**
     * Checks if this day is a LUNES.
     *
     * @return bool
     */
    public function isLUNES()
    {
        return $this->dayOfWeek === static::LUNES;
    }

    /**
     * Checks if this day is a Martes.
     *
     * @return bool
     */
    public function isMartes()
    {
        return $this->dayOfWeek === static::MARTES;
    }

    /**
     * Checks if this day is a Miercoles.
     *
     * @return bool
     */
    public function isMiercoles()
    {
        return $this->dayOfWeek === static::MIERCOLES;
    }

    /**
     * Checks if this day is a Jueves.
     *
     * @return bool
     */
    public function isJueves()
    {
        return $this->dayOfWeek === static::JUEVES;
    }

    /**
     * Checks if this day is a Viernes.
     *
     * @return bool
     */
    public function isViernes()
    {
        return $this->dayOfWeek === static::VIERNES;
    }

    /**
     * Checks if this day is a Sabado.
     *
     * @return bool
     */
    public function isSabado()
    {
        return $this->dayOfWeek === static::SABADO;
    }
     ...
     * to indicate the desired dayOfWeek, ex. static::LUNES.
     *
     ...
     * Use the supplied consts to indicate the desired dayOfWeek, ex. static::LUNES.
     *
     * @param int $nth
     * @param int $dayOfWeek
     *
